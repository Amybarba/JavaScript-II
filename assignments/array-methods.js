...
let fullName = [];
let runnerNames = runners.forEach(function(i){
...
// Problem 1
let companyName = [];
let nameDonation = runners.forEach(function(i){
    companyName.push(i.company_name + " " + i.donation); 
});
console.log(companyName);

// Problem 2
let searchNames = runners.filter ((names) => {
    return names.first_name === "Hank";
});
console.log(searchNames);


// Problem 3
let lnBold = runners.map((person) => {
    return person.last_name.bold();     
});
console.log(lnBold); 